...
std::string readFromFile(const std::string& filename)
{
    ...
    // std::ifstream работает по аналогии с std::cin
    // но данные считываются не из консоли, а из файла
    // std::ofstream работает по аналогии с std::cout
    // только данные выводятся не в консоль, а записываются в файл
    // std::fstream объединяет в себе std::ifstream и std::ofstream
    // и работает в зависимости от второго аргумента
...
void vectorToFile(const std::string& filename, const std::vector<int>& data)
{
    ...
    // когда файл открывается для записи данных,
    // другие программы не могут читать или записывать данные в него
